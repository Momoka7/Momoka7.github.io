...
传入简单的String message对象上文已经使用了；使用`Prompt`对象可以传入更加复杂的参数：
...
![截图](056c23b4e3d74a1747f9bfca12ecfe75.png)

![截图](4498ecfb8c6dc191d3601fcaaa10e615.png)

![截图](acc94cfcd2b5a1d02c30af3f5dd438d9.png)
